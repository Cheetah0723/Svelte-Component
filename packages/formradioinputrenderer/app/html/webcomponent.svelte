...
<div class="form-check">
	<input bind:group={value} type="radio" class="form-check-input" name={schemaentry?.params?.group} id={schemaentry?.id} required={schemaentry?.required} readonly={schemaentry?.readonly} />
